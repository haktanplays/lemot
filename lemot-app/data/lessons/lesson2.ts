...
export const lesson2: Lesson = {
  ...
  grammar: {
    ...
    sections: [
      ...
      {
        type: "block",
        label: "Pronunciation: Nasal Vowels & Silent 'est'",
        items: [
          {
            fr: "sont → /sɔ̃/",
            en: "Nasal vowel: the 'on' sound",
            note: "In 'sont', the 'on' is nasal — air goes through your nose. Don't pronounce the 'n' or 't'. It's not 'sonnt' — it's a pure nasal 'soh(n)'.",
          },
          {
            fr: "est → /ɛ/",
            en: "The 'st' is completely silent",
            note: "'Il est' sounds like 'eel EH'. The 's' and 't' are both silent. This is one of the most common words in French — get this sound right early.",
          },
          {
            fr: "bon → /bɔ̃/",
            en: "Another nasal: 'bon' rhymes with 'sont'",
            note: "Nasal vowels are one of French's signature sounds. English doesn't have them. Let the air flow through your nose.",
          },
        ],
      },
      {
  ...
  summary: [
    ...
    "Nasal vowels: sont /sɔ̃/, silent 'est' /ɛ/",
