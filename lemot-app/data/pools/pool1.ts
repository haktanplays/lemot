...
export const fillFG1: FillItem[] = [
  ...
  { s: "[___] me, is there a metro nearby?", a: "Excusez", o: ["Excusez", "Merci", "Bonjour", "Voilà"], ctx: "You're lost in a neighborhood you've never visited.", fr: "Excusez-moi, y a-t-il un métro près d'ici ?", diff: "easy" },
  ...
  { s: "[___] me, I don't [___] this menu.", a: "Excusez", blanks: ["Excusez", "comprends"], blankOpts: [["Excusez", "Merci", "Bonjour"], ["comprends", "voudrais", "parle"]], ctx: "At a countryside restaurant. The menu is entirely in French with no pictures.", fr: "Excusez-moi, je ne comprends pas ce menu.", diff: "medium" },
  ...
  { s: "[___] me, I ne [___] pas. Pouvez-vous [___] ?", a: "Excusez", blanks: ["Excusez", "comprends", "répéter"], blankOpts: [["Excusez", "Merci", "Bonjour"], ["comprends", "voudrais", "parle"], ["répéter", "manger", "partir"]], ctx: "Directions involved 4 turns and you're lost.", fr: "Excusez-moi, je ne comprends pas. Pouvez-vous répéter ?", diff: "hard" },
  ...
  { s: "[___] ! Je ne [___] [___]. [___] ?", a: "Pardon", blanks: ["Pardon", "comprends", "pas", "Répéter"], blankOpts: [["Pardon", "Bonjour", "Voilà"], ["comprends", "voudrais", "suis"], ["pas", "bien", "mal"], ["Répéter", "Manger", "Partir"]], ctx: "First day in France. Signs, menus, conversations — everything is in French.", fr: "Pardon, je ne comprends pas. Pouvez-vous répéter ?", diff: "hard" },
  ...
  { s: "[___] me, je [___] l'addition, [___] vous plaît. [___] !", a: "Excusez", blanks: ["Excusez", "voudrais", "s'il", "Merci"], blankOpts: [["Excusez", "Merci", "Bonjour"], ["voudrais", "comprends", "suis"], ["s'il", "au", "en"], ["Merci", "Pardon", "Voilà"]], ctx: "Dinner was great but the waiter disappeared. You wave him over.", fr: "Excusez-moi, je voudrais l'addition, s'il vous plaît. Merci !", diff: "hard" },
