...
export const fillFG1: FillItem[] = [
  ...
  { s: "[___], welcome to our restaurant.", a: "Bonsoir", o: ["Bonsoir", "Bonjour", "Salut", "Pardon"], ctx: "It's 8:30 PM. A hostess greets you at the door.", diff: "easy" },
  ...
  { s: "I don't [___]. Please speak English.", a: "comprends", o: ["comprends", "voudrais", "Bonjour", "Merci"], ctx: "A taxi driver asks you something and you have no idea.", diff: "easy" },
  ...
  { s: "[___] ! Here's your change.", a: "Voilà", o: ["Voilà", "Merci", "Bonjour", "Pardon"], ctx: "A cashier hands you your change. French equivalent of 'there you go'.", diff: "easy" },
  ...
  { s: "[___] for helping me, [___]!", a: "Merci", blanks: ["Merci", "au revoir"], blankOpts: [["Merci", "Pardon", "Bonjour"], ["au revoir", "bonjour", "salut"]], ctx: "Your Airbnb host helped with luggage, directions, and tips. Time to go.", diff: "medium" },
  ...
  { s: "[___], I don't [___]. Pouvez-vous parler plus lentement ?", a: "Pardon", blanks: ["Pardon", "comprends"], blankOpts: [["Pardon", "Bonjour", "Voilà"], ["comprends", "voudrais", "Merci"]], ctx: "A local asks you for directions. You want to help but your French is limited.", diff: "medium" },
  { s: "[___]! I [___] a taxi, please.", a: "Excusez-moi", blanks: ["Excusez-moi", "voudrais"], blankOpts: [["Excusez-moi", "Merci", "Salut"], ["voudrais", "comprends", "parle"]], ctx: "It's raining. You need a cab to the airport.", diff: "medium" },
  { s: "[___], I [___] a room for tonight.", a: "Bonsoir", blanks: ["Bonsoir", "voudrais"], blankOpts: [["Bonsoir", "Bonjour", "Salut"], ["voudrais", "comprends", "suis"]], ctx: "Checking into a hotel after a late arrival.", diff: "medium" },
  { s: "[___] beaucoup ! [___] !", a: "Merci", blanks: ["Merci", "Au revoir"], blankOpts: [["Merci", "Pardon", "Bonjour"], ["Au revoir", "Bonsoir", "Salut"]], ctx: "A stranger carried your suitcase up three flights of stairs. You thank them and leave.", diff: "medium" },
  { s: "[___], I [___] to check in, please.", a: "Bonsoir", blanks: ["Bonsoir", "voudrais"], blankOpts: [["Bonsoir", "Bonjour", "Salut"], ["voudrais", "comprends", "suis"]], ctx: "You arrive at a small hotel after dark. The receptionist looks up.", diff: "medium" },
  { s: "I don't [___]. Can you [___], please?", a: "comprends", blanks: ["comprends", "répéter"], blankOpts: [["comprends", "voudrais", "parle"], ["répéter", "manger", "partir"]], ctx: "Someone gave you an address verbally but you kept mishearing it.", diff: "medium" },
  { s: "[___], [___] est la pharmacie ?", a: "Excusez-moi", blanks: ["Excusez-moi", "où"], blankOpts: [["Excusez-moi", "Au revoir", "Voilà"], ["où", "qui", "quand"]], ctx: "It's 7 PM and you urgently need medicine. Most shops close early.", diff: "medium" },
  ...
  { s: "Non [___], je [___] juste regarder.", a: "merci", blanks: ["merci", "voudrais"], blankOpts: [["merci", "pardon", "bonjour"], ["voudrais", "comprends", "suis"]], ctx: "A shopkeeper approaches. You want to browse without pressure.", diff: "medium" },

  // ── 3 blanks — Hard (10) ──
  { s: "[___], I [___] a [___] crème, please.", a: "Bonjour", blanks: ["Bonjour", "voudrais", "café"], blankOpts: [["Bonjour", "Merci", "Pardon"], ["voudrais", "comprends", "suis"], ["café", "salut", "pardon"]], ctx: "First time at a Parisian café. You want a café crème (coffee with milk).", diff: "hard" },
  { s: "[___] me, I ne [___] pas. Pouvez-vous [___] ?", a: "Excusez", blanks: ["Excusez", "comprends", "répéter"], blankOpts: [["Excusez", "Merci", "Bonjour"], ["comprends", "voudrais", "parle"], ["répéter", "manger", "partir"]], ctx: "Directions involved 4 turns and you're lost.", diff: "hard" },
  { s: "[___] ! [___] ! I [___] a table for four people.", a: "Bonsoir", blanks: ["Bonsoir", "Excusez-moi", "voudrais"], blankOpts: [["Bonsoir", "Salut", "Merci"], ["Excusez-moi", "Au revoir", "Voilà"], ["voudrais", "comprends", "Bonjour"]], ctx: "Your family just arrived. The restaurant looks busy.", diff: "hard" },
  { s: "Je ne [___] [___] bien. Pouvez-vous [___] ?", a: "comprends", blanks: ["comprends", "pas", "répéter"], blankOpts: [["comprends", "voudrais", "parle"], ["pas", "bien", "mal"], ["répéter", "manger", "partir"]], ctx: "A police officer is asking questions. You need them to slow down.", diff: "hard" },
  { s: "[___] ! [___] beaucoup ! [___] !", a: "Bonjour", blanks: ["Bonjour", "Merci", "Au revoir"], blankOpts: [["Bonjour", "Pardon", "Bonsoir"], ["Merci", "Voilà", "Salut"], ["Au revoir", "Bonjour", "Salut"]], ctx: "A local walked with you for 10 minutes. You greet, thank, and part ways.", diff: "hard" },
  { s: "[___] ! Je ne [___] [___] l'annonce.", a: "Pardon", blanks: ["Pardon", "comprends", "pas"], blankOpts: [["Pardon", "Bonjour", "Voilà"], ["comprends", "voudrais", "parle"], ["pas", "bien", "mal"]], ctx: "Gare du Nord. Platform change announced only in French.", diff: "hard" },
  ...
  { s: "Je ne [___] [___]. [___], pouvez-vous répéter ?", a: "comprends", blanks: ["comprends", "pas", "Pardon"], blankOpts: [["comprends", "voudrais", "suis"], ["pas", "bien", "mal"], ["Pardon", "Bonjour", "Voilà"]], ctx: "At a doctor's office trying to explain your symptoms.", diff: "hard" },
  { s: "[___], [___] est la banque ? [___] !", a: "Excusez-moi", blanks: ["Excusez-moi", "où", "Merci"], blankOpts: [["Excusez-moi", "Au revoir", "Salut"], ["où", "qui", "quand"], ["Merci", "Pardon", "Voilà"]], ctx: "You ran out of cash and need to find a bank.", diff: "hard" },
  { s: "[___] ! Je [___] changer mon vol, [___] vous plaît.", a: "Pardon", blanks: ["Pardon", "voudrais", "s'il"], blankOpts: [["Pardon", "Bonjour", "Voilà"], ["voudrais", "comprends", "parle"], ["s'il", "au", "en"]], ctx: "At the airline counter. Your connecting flight was cancelled.", diff: "hard" },
  ...
  { s: "[___] ! Je ne [___] [___]. [___] ?", a: "Pardon", blanks: ["Pardon", "comprends", "pas", "Répéter"], blankOpts: [["Pardon", "Bonjour", "Voilà"], ["comprends", "voudrais", "suis"], ["pas", "bien", "mal"], ["Répéter", "Manger", "Partir"]], ctx: "First day in France. Signs, menus, conversations — everything is in French.", diff: "hard" },
  { s: "[___] ! [___] ! I [___] a room for two nights, [___] vous plaît.", a: "Bonsoir", blanks: ["Bonsoir", "Excusez-moi", "voudrais", "s'il"], blankOpts: [["Bonsoir", "Salut", "Merci"], ["Excusez-moi", "Au revoir", "Voilà"], ["voudrais", "comprends", "parle"], ["s'il", "au", "en"]], ctx: "You arrive at a countryside inn exhausted after a long drive.", diff: "hard" },
  { s: "[___] me, je [___] l'addition, [___] vous plaît. [___] !", a: "Excusez", blanks: ["Excusez", "voudrais", "s'il", "Merci"], blankOpts: [["Excusez", "Merci", "Bonjour"], ["voudrais", "comprends", "suis"], ["s'il", "au", "en"], ["Merci", "Pardon", "Voilà"]], ctx: "Dinner was great but the waiter disappeared. You wave him over.", diff: "hard" },
  { s: "[___] ! [___], je ne [___] [___]. Pouvez-vous répéter ?", a: "Excusez-moi", blanks: ["Excusez-moi", "Pardon", "comprends", "pas"], blankOpts: [["Excusez-moi", "Merci", "Salut"], ["Pardon", "Bonjour", "Voilà"], ["comprends", "voudrais", "parle"], ["pas", "bien", "mal"]], ctx: "At a busy market. The vendor is explaining prices but you're overwhelmed.", diff: "hard" },
  ...
  { s: "Je [___] une baguette, s'il vous plaît.", a: "voudrais", o: ["voudrais", "comprends", "Merci", "Pardon"], ctx: "Ordering bread — the classic L1 pattern.", diff: "medium" },
