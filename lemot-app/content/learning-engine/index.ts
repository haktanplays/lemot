...
export { L1_ITEMS, L14_ITEMS } from "./items";
...
import { L1_ITEMS, L14_ITEMS } from "./items";
...
export const LEARNING_ENGINE_FIXTURE: ValidationInput = {
  items: { ...L1_ITEMS, ...L14_ITEMS },
  presets: PRESETS,
  contracts: [L1_CONTRACT, L14_CONTRACT],
  exercises: [...L1_EXERCISES, ...L14_EXERCISES],
};
