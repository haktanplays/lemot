  ...
  },
  {
    ...
    payload: {
      ...
      examples: [
        ...
        { fr: "un restaurant, une maison", en: "a restaurant, a house (the package travels everywhere)" },
...
export const lesson005: Lesson = {
  ...
  designNotes: [
    ...
    "Kademe 2 enrichment: un thé (dual role: L1 service variation, here article reinforcement; the s05 weave accepts the thé slot-swap) and une table (s04c fill) join as supported packages. un restaurant / une maison stay ghost-only in the insight example copy.",
