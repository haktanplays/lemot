...
const screens: LessonScreen[] = [
  ...
  },
  {
    ...
    payload: {
      ...
      highlights: [
        { text: "vous pouvez m'aider", itemId: "chunk-vous-pouvez-m-aider" },
      ],
      tts: true,
    },
  },
...
export const lesson010: Lesson = {
  ...
  designNotes: [
    ...
    "chunk-vous-pouvez-m-aider carries registry status supported (its steady-state L11 role); its L10 use is recognition-only by lesson design, since registry status is static.",
