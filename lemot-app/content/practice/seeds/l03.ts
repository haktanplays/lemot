...
export const L3_SEEDS: PracticeSeed[] = [
  ...
  buildSeed({
    ...
    surface: "build",
    lesson: L,
    required: ["chunk-non", "chunk-je-ne-suis-pas", "word-ici"],
    targets: ["chunk-non", "chunk-je-ne-suis-pas"],
  ...
  buildSeed({
    ...
    surface: "build",
    lesson: L,
    required: ["chunk-non", "chunk-ce-n-est-pas", "word-ici", "chunk-je-ne-suis-pas"],
    targets: ["chunk-ce-n-est-pas"],
    tags: ["negation"],
    repairs: "negation",
  ...
  weaveSeed({
    ...
    surface: "dictation",
    lesson: L,
    required: ["chunk-ce-n-est-pas", "word-ici"],
    targets: ["chunk-ce-n-est-pas"],
    audio: "Ce n'est pas ici.",
    weaveType: "open",
    prompt: "Write what you hear.",
