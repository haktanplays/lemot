...
describe("journeyRole — shipped map", () => {
  ...
  test("JR-003 — L1..L24 each declare a role; L0 does not", () => {
    ...
    assertEqual(countDeclaredJourneyRoles(V1_LESSONS), 24, "24 of 25 lessons carry a role");
  });
