...
| "Bir kavram ne zaman tanıtılmalı?" | **Cairn Curriculum Charter v1.0** (`docs/bibles/curriculum/CURRICULUM_CHARTER_v1.0.md`, DOC-058 — **Canonical, 2026-07-28**) ratified L0–L17 spine içinde; **post-L17 için Curriculum Bible hâlâ `NOT YET AUTHORED` → dur ve bildir**. Canonical ≠ implemented: runtime görünürlüğü (L6 cap) ve freeze'ler değişmedi |
...
| "Bir item nasıl sayılır? Active-new 1–4 neyi sayar?" | **PRJ-015 Item-Counting Contract v1.0** (`docs/bibles/curriculum/PRJ_015_ITEM_COUNTING_CONTRACT_v1.0.md`, DOC-062 — **Canonical, 2026-07-29**; Curriculum alt-otoritesi). Canonical ≠ implemented: hiçbir validator/runtime enforcement yok; tarihsel `8–15` SUPERSEDED |
