...
> [!warning] Bu sayılar ayrı şeyleri sayar ve toplanamaz; *Policy Hardening* bölümündeki activeNew sözleşmeleri **değişmedi** ve Doorway/Integration/Review/Milestone için yazılmış-yüzey veya render bandı **uydurulmadı** (**[OPEN]**). `journeyRole` metadata alanı **koda eklenmedi** → sözleşmeler makine ile **denetlenemez**. Chip-composition muhasebesi **[OPEN]**'dır ve journey-role taksonomisini **etkilemez**; Review/Milestone'un sevkedilmiş örneği **yoktur**. Tanım evi: Content Bible v1.0 §6.7b/§6.8/§6.9. Ekran sayısı ve süre **sayı tutturmak için artırılamaz**; hiçbir sayı runtime'da enforce edilmez.
