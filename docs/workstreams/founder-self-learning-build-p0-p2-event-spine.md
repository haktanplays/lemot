# Founder Self-Learning Build — P0–P2 (Local Deterministic Event Spine)
...
>
> **Naming note:** the repo convention is `Sprint{N}_SW{X}_{slug}.md`. This file uses a
> descriptive, sprint-agnostic name because the Founder Self-Learning Build spans multiple
> sprints and is not a Sprint 12 sub-workstream. Rename to a `Sprint{N}_SW{X}_…` form if the
> operator assigns it to a specific sprint.
