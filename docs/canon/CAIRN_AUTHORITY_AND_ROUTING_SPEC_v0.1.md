...
| **Curriculum** | **Curriculum Charter v1.0 (DOC-058)** | 🟡 **PARTIALLY AUTHORED** — Charter Canonical (founder-signed 2026-07-28); the **Curriculum Bible remains unauthored** | Charter governs the current L0–L17 tiered spine, thesis, cadence, and stop conditions; **counting questions route to the Item-Counting Contract v1.0 (DOC-062, Canonical 2026-07-29 — PRJ-015 resolved, Not Implemented)**. Post-L17 sequencing and Capability Arcs remain open. Fragments: DOC-027, DOC-028 (reference beneath the Charter) |
...
| 2026-07-29 | 0.1 (PRJ-015 Contract promotion) | **§2 Curriculum row updated:** counting questions (what does active-new 1–4 count · frames + linked IDs once or several · fillers · chunks/packages/senses/inflection/gender · which historical numbers remain valid) now route to **DOC-062 PRJ-015 Item-Counting Contract v1.0 (`Canonical`, founder-signed 2026-07-29)** — a subordinate Curriculum authority; the missing-owner path no longer applies to counting. **PRJ-015 `OPEN` → `CANONICAL` (Not Implemented)**; post-L17 sequencing and Capability Arcs keep the missing-owner path; **Canonical ≠ implemented; no validator or enforcement exists; no implementation authorized.** | Cloud session (founder-signed promotion) |
