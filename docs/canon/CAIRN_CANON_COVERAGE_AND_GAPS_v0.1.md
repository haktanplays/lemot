...
|---|---|---|---|---|---|---|
| **Curriculum Bible** *(Charter stage complete 2026-07-28 — DOC-058 governs the L0–L17 spine; the Bible itself remains unauthored)* | Post-L17 sequencing, Capability Arcs, and counting are unowned; the Charter's stop conditions route them | When is a concept introduced beyond L17? What is the band/Arc architecture? *(How is an item counted → now answered by DOC-062, Canonical 2026-07-29)* | DOC-058 (Charter) + DOC-027, DOC-028 (reference) | Product Brain, Content Bible, **Mastery & Evidence Bible (DOC-051 — consumes its semantics)** | Content authoring, Reading taxonomy, post-L24 | **Yes** — for new lesson work beyond the ratified spine |
