...
- **Still open (the full Curriculum Bible and complete sequencing architecture):** post-L17 sequencing, Capability Arc composition, item-counting methodology (PRJ-015), tense architecture, broader skill progression, assessment/remediation. **PRJ-001 remains `OPEN` with narrowed scope.**
...
| **Curriculum** | **DOC-058 Charter v1.0** (2026-07-28) | `PARTIALLY AUTHORED` — Canonical Charter; Bible open | Medium-High | 4 (PRJ-001 narrowed, PRJ-015, PRJ-029, post-L17/Arcs) | Medium | 🟡 For Charter-scope rulings (L0–L17 spine, cadence, boundaries); ❌ beyond | **Step 2 (continued) — Author Curriculum Bible when maturity bar met (Charter §16)** |
...
**Step 2 — Curriculum Bible.** 🟡 **Charter stage complete 2026-07-28** (FQ-C0): **Cairn Curriculum Charter v1.0 (DOC-058, Canonical, founder-signed)** now governs the current L0–L17 tiered spine, thesis, macro-map hierarchy, and integration cadence, and **routes** the remaining items — item-counting methodology (PRJ-015, first post-opening decision track) · post-L24 direction (PRJ-029) · Reading sequencing dependencies (PRJ-012) · post-L17 sequencing and Capability Arcs — as explicit open work with stop conditions. **The Curriculum Bible itself — Step 2's full end-state — remains unauthored** and is authored only when the Charter §16 maturity bar is met. *Prereqs:* Steps 0–1 (met). *Risk if later:* post-spine lesson authoring stays blocked.
