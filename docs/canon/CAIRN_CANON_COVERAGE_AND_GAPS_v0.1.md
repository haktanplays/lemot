...
> **`FRAGMENTED` ≠ `ABSENT`.** Cairn's characteristic state is *rich material, no owner*. Five domains have substantial documentation and no authoritative document (Engineering/System, Privacy/Legal, Operations & QA, UX/Experience, Brand — §3). Treating them as empty would be wrong and would invite an agent to rewrite what already exists. *(Mastery & Evidence left this state on 2026-07-27, when its Bible was promoted to Canonical — §2.4. Curriculum moved to `PARTIALLY AUTHORED` on 2026-07-28, when the Curriculum Charter v1.0 was promoted — §3.1; its Bible remains unauthored.)*
...
- **Open dependencies:** French style guide absent (PRJ-010); named reviewer absent (PRJ-011); Reading taxonomy/validator open (PRJ-012); Mon Lexique band copy deferred (PRJ-019). *(Item-counting methodology — PRJ-015 — resolved 2026-07-29 by the Item-Counting Contract v1.0, DOC-062; the 1–4 invariant's unit is now defined; enforcement remains unbuilt.)*
...
### 3.1 Curriculum — `PARTIALLY AUTHORED` *(was `FRAGMENTED`; updated 2026-07-28)*
- **Canonical Charter exists:** **Cairn Curriculum Charter v1.0 (DOC-058)**, founder-signed 2026-07-28 after a sign-off review (`READY WITH NON-BLOCKING NOTES`, DOC-061). It governs the current **L0–L17 tiered spine** (L0–L6 locked/shipped/frozen · L7–L15 approved working sequence, revisable · L16–L17 spec-only · L18+ unratified), the curriculum thesis, the Journey→Capability-Arc macro-map disposition, the integration rhythm contract, prerequisite/promotion boundaries, and stop conditions. Supporting records: DOC-059 (discovery), DOC-060 (founder ratification), DOC-061 (sign-off review).
- **Still open (the full Curriculum Bible and complete sequencing architecture):** post-L17 sequencing, Capability Arc composition, tense architecture, broader skill progression, assessment/remediation. **PRJ-001 remains `OPEN` with narrowed scope.** *(Item-counting methodology — PRJ-015 — resolved 2026-07-29: **Item-Counting Contract v1.0 (DOC-062, Canonical)**, a subordinate Curriculum authority; one Charter §16 maturity prerequisite satisfied; implementation deferred.)*
- **Source fragments (now reference beneath the Charter):** DOC-027 (26 vault notes incl. `Syllabus Design Rules`, `Level and Band Map`, L0–L17 notes, `L18-L24 Roadmap`); DOC-028 (30 lesson/compact specs); `docs/architecture/l0-l24-founder-build-matrix-v0.md`.
- **Contradictions:** cadence three-way conflict resolved by FQ-C4 (Rhythm Contract binding; older phrasings superseded/historical — source banners are a follow-up, N1); item counts 54/56/52 explained and dispositioned by DOC-062 IC-006 (C6 closed: 52 = pre-hygiene snapshot, 56 = never-real artifact, 54 = current, 59 = separate engine registry); dev-APK scope L1–L5 canon vs L0–L6 runtime (C2) remains Ops work (N2); L7 full-aller vs compact-doorway resolved for the next PR, full spec preserved deferred.
- **Risk if an agent acts today:** inventing a post-L17 placement, Capability Arc, or counting rule — the Charter's §14 stop conditions now govern exactly this.
- **Final form unchanged:** a **Curriculum Bible** (Step 2's end-state) owning the full sequencing architecture; the Charter is its v0.x/v1.0 governance stage, not its substitute.
...
|---|---|---|---|---|---|---|
| **Curriculum Bible** *(Charter stage complete 2026-07-28 — DOC-058 governs the L0–L17 spine; the Bible itself remains unauthored)* | **Post-L17 sequencing and Capability Arc composition remain unowned** (with the full Bible architecture); the Charter's stop conditions route them. **Item-counting methodology is now governed by DOC-062** (Canonical 2026-07-29): the active-new unit, frame/filler and linked-identity accounting, and the historical-number disposition are owned, not missing | When is a concept introduced beyond L17? What is the band/Arc architecture? *(How is an item counted — **already answered** by DOC-062; not part of the missing Bible scope)* | DOC-058 (Charter) + **DOC-062 (Item-Counting Contract v1.0)** + DOC-027, DOC-028 (reference) | Product Brain, Content Bible, **Mastery & Evidence Bible (DOC-051 — consumes its semantics)** | Content authoring, Reading taxonomy, post-L24 | **Yes** — for new lesson work beyond the ratified spine |
...
| 8 | Item counts 54/56/52 | C6 | *resolved 2026-07-29 by DOC-062 IC-006 (52 snapshot / 54 current / 56 artifact / 59 engine registry)* |
...
| **Curriculum** | **DOC-058 Charter v1.0** (2026-07-28) + **DOC-062 Item-Counting Contract v1.0** (2026-07-29, subordinate) | `PARTIALLY AUTHORED` — Canonical Charter + counting sub-authority; Bible open | Medium-High | 3 (PRJ-001 narrowed, PRJ-029, post-L17/Arcs — PRJ-015 resolved) | Medium | 🟡 For Charter-scope and counting rulings; ❌ beyond | **Step 2 (continued) — Author Curriculum Bible when maturity bar met (Charter §16)** |
...
**Step 2 — Curriculum Bible.** 🟡 **Charter stage complete 2026-07-28** (FQ-C0): **Cairn Curriculum Charter v1.0 (DOC-058, Canonical, founder-signed)** now governs the current L0–L17 tiered spine, thesis, macro-map hierarchy, and integration cadence, and **routes** the remaining items — post-L24 direction (PRJ-029) · Reading sequencing dependencies (PRJ-012) · post-L17 sequencing and Capability Arcs — as explicit open work with stop conditions. *(The first post-opening decision track — item-counting methodology, PRJ-015 — **completed 2026-07-29**: Item-Counting Contract v1.0, DOC-062, Canonical; one §16 maturity prerequisite satisfied; the others remain open.)* **The Curriculum Bible itself — Step 2's full end-state — remains unauthored** and is authored only when the Charter §16 maturity bar is met. *Prereqs:* Steps 0–1 (met). *Risk if later:* post-spine lesson authoring stays blocked.
...
**Current standing (2026-07-28, post-Curriculum-Charter-promotion):** **5 of 12 required layers satisfy the paper-complete layer criterion** — enumerated from the list above: **Project Canon** (1, Map v1.0), **Product Brain** (2, v1.0), **Content Bible** (3, v1.0), **Social Layer** Charter (4, v1.0), and **Mastery & Evidence Bible** (5, v1.0 — Canonical 2026-07-27). **The count did not change on 2026-07-28**: criterion 6 requires the **Curriculum Bible** to be Canonical, and the **Curriculum Charter v1.0 (DOC-058) is not the Bible** — Curriculum is now `PARTIALLY AUTHORED` (Canonical Charter exists; full Bible and complete sequencing architecture remain open), which narrows but does not satisfy criterion 6.

**Seven required layers remain:** Curriculum (Bible; Charter stage complete) · Brand · Engineering/System · Privacy/Legal · UX/Experience · Operations & QA · Future Systems Register.
...
| 2026-07-28 | 0.1 (Curriculum Charter promotion) | **Curriculum moved `FRAGMENTED` → `PARTIALLY AUTHORED`.** §3.1 rewritten: **Cairn Curriculum Charter v1.0 (DOC-058, Canonical, founder-signed 2026-07-28** after sign-off review `READY WITH NON-BLOCKING NOTES`, DOC-061; supporting records DOC-059…DOC-061**)** governs the current L0–L17 tiered spine, thesis, macro-map disposition, integration cadence, and stop conditions. §1 note: six → **five** fragmented-without-owner domains. §4 Curriculum row annotated (Charter stage complete; Bible-scope dependencies remain). §10 matrix: Curriculum → `PARTIALLY AUTHORED`, agent-ready 🟡 for Charter-scope rulings only. §11 Step 2 annotated: **Charter stage complete; the Curriculum Bible — Step 2's full end-state — remains unauthored**, authored only at the Charter §16 maturity bar. §12 standing: **count unchanged at 5 of 12, 7 remaining** — criterion 6 names the *Bible*, which the Charter is not. **PRJ-001 remains `OPEN` with narrowed scope; PRJ-015/029/036 remain `OPEN`; L18+ unratified; paper complete NOT reached; no code-return gate passed; no implementation authorized.** | Cloud session (founder-signed promotion) |

| 2026-07-29 | 0.1 (PRJ-015 Contract promotion) | **Item-counting methodology resolved.** §3.1, §2.2 deps, §4 row, §5 blind spot 8, §10 matrix (Curriculum open decisions 4 → 3), and §11 Step 2 updated: **PRJ-015 Item-Counting Contract v1.0 (DOC-062, Canonical, founder-signed 2026-07-29)** is a subordinate Curriculum authority; the C6 count contradiction closed (52 snapshot / 54 current / 56 artifact / 59 engine registry); one Charter §16 maturity prerequisite satisfied. **Curriculum remains `PARTIALLY AUTHORED`; the Curriculum Bible remains unauthored; paper-complete standing unchanged at 5 of 12, 7 remaining (no new layer — DOC-062 is subordinate, not layer-counted); no code-return gate passed; implementation Not Implemented; no enforcement authorized.** | Cloud session (founder-signed promotion) |
